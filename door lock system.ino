...
char Specific[Password_Length] = "8888"; // the password which is called specific in the code, change this to anything you want with the numbers 0-9 an dthe letters A-D
...
void setup()
{
  ...
  lcd.print("NAST"); // prints the text/charater
